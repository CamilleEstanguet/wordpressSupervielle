...
register_default_headers(
	array(
		'default-image' => array(
			'url'           => get_template_directory_uri() . '/assets/img/frontpage_lycée4.jpg',
			'thumbnail_url' => get_template_directory_uri() . '/assets/img/frontpage_lycée4.jpg',
	...
	add_theme_support(
		...
		apply_filters(
			...
			array(
				...
				'default-image'      => get_template_directory_uri() . '/assets/img/frontpage_lycée4.jpg',
				'flex-width'         => true,
				'flex-height'        => true,
				'width'              => 2200,
