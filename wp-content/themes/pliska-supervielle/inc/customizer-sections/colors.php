...
function pliska_customize_colors( $wp_customize ) {
	...
	$wp_customize->get_section( 'colors' )->description = esc_html__( 'Personnalisations de certaines couleurs', 'pliska' );
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			array(
				...
				'section'     => 'colors',
				'description' => esc_html__( "Pour modifier la direction du dégradé de l'image d'en-tête, la densité ou la supprimer complètement, accédez à la section Options d'en-tête", 'pliska' ),
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'pliska_gradient_color_two',
			array(
				'label'   => esc_html__( 'Image d\'en-tête Dégradé de couleur', 'pliska' ),
				'section' => 'colors',
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'nav_top_menu_text_color',
			array(
				'label'       => esc_html__( 'Couleur du texte du menu d\'en-tête', 'pliska' ),
				'section'     => 'colors',
				'description' => esc_html__( "La couleur du texte du menu lorsque vous faites défiler la page. Pour modifier le comportement du menu (menu persistant, fixe ou statique), accédez à la section Options d'en-tête", 'pliska' ),
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'nav_text_color',
			array(
				'label'   => esc_html__( 'Couleur de texte du sous-menu', 'pliska' ),
				'section' => 'colors',
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'nav_color',
			array(
				'label'   => __( 'couleur de fond du sous menu', 'pliska' ),
				'section' => 'colors',
				'type'    => 'color',
			)
		)
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'mobile_menu_background',
			array(
				'label'   => __( 'Couleur de fond du menu pour téléphones', 'pliska' ),
				'section' => 'colors',
				'type'    => 'color',
			)
		)
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'headings_text_color',
			array(
				'label'   => esc_html__( 'Couleurs de texte d\'en tête', 'pliska' ),
				'section' => 'colors',
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'body_text_color',
			array(
				'label'   => esc_html__( 'Couleur de texte du corps', 'pliska' ),
				'section' => 'colors',
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'links_text_color',
			array(
				'label'   => esc_html__( 'Couleurs des liens', 'pliska' ),
				'section' => 'colors',
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'links_hover_color',
			array(
				'label'   => esc_html__( 'Couleurs des liens quand on place son curseur dessus', 'pliska' ),
				'section' => 'colors',
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'primary_accent_color',
			array(
				'label'   => esc_html__( 'Couleur primaire d\'accent', 'pliska' ),
				'section' => 'colors',
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'secondary_accent_color',
			array(
				'label'   => esc_html__( 'Couleur secondaire d\'accent', 'pliska' ),
				'section' => 'colors',
			)
		)
	);
