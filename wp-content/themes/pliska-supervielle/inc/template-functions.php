...
function pliska_display_related_posts() {
	...
	$default_related_post_image = get_theme_mod( 'image_control_one', esc_url(get_template_directory_uri()) . '/assets/img/300X225.jpg' );
	...
	if ( $show_related_posts || is_customize_preview() ) {
		...
		<div class="related-posts-wrapper
			...
			<h2><?php _e( 'articles en relations', 'pliska' );?></h2>
